...
import com.projeto.project_spring.services.exception.exceptions.StandartError;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandartError> resourceNotFound(ResourceNotFoudException e, HttpServletRequest request){
